...
public class BuildMart implements ModInitializer {
	...
	public void onInitialize() {
		...
		CommandRegistrationCallback.EVENT.register((dispatcher, buildContext, selection) -> {
			...
			LOGGER.info("命令注册完成（bal/pay/baltop/bmhelp/announcement/eco/shop/price/buy/bm/fastbuy/fly/home/sethome/delhome/listhome/tpa/tpahere/tpaccept/back/suicide/hongbao/config）");
		});
